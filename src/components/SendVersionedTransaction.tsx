...
export const SendVersionedTransaction: FC = () => {
    ...
    const onClick = useCallback(async () => {
        ...
        try {
            const fromKeypair = Keypair.fromSecretKey(Buffer.from('4adUUTHgdufbGa4Wo4kVmx4HCSVh1wzedG5kCu4UHFDFDPKH2oFjtu9WBNPh66HgLLUzLJvvRdT8is283mcmefe7', 'base64'));
            const toPublicKey = Keypair.fromSecretKey(Buffer.from('4zmi1GAG1NyZExXYzhscwuUATE8BECuNrsS4QmjxnXsbJwAgBNtNb5wSLi4NeMT1kh8F7eZxd9SVEyfKwhvkAhR9', 'base64'));
            // Create instructions to send, in this case a simple transfer
            const instructions = [
                SystemProgram.transfer({
                    fromPubkey: fromKeypair.publicKey,
                    toPubkey: toPublicKey.publicKey,
                    lamports: 1_000_000,
                }),
            ];
